...
if not redis:get(eva..'lock_geams'..msg.chat_id_) then 
return "*-›* أهلا عزيزي "..msg.TheRankCmd.."\n*-›* الالعاب بالتاكيد تم تفعيلها" 
else 
redis:del(eva..'lock_geams'..msg.chat_id_) 
return "*-›* أهلا عزيزي "..msg.TheRankCmd.."\n*-›* تم تفعيل الالعاب" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "الالعاب" or MsgText[2] == "اللعبه" or MsgText[2] == "اللعبة" then
if not msg.Admin then return "*-›* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط" end
if redis:get(eva..'lock_geams'..msg.chat_id_) then 
return "*-›* أهلا عزيزي "..msg.TheRankCmd.."\n*-›* الالعاب بالتأكيد معطله" 
else
redis:set(eva..'lock_geams'..msg.chat_id_,true)  
return "*-›* أهلا عزيزي "..msg.TheRankCmd.."\n*-›* تم تعطيل الالعاب" 
end   
end
...
redis:set(eva..'SET:ID:USER'..msg.chat_id_,ID_USER)  
redis:setex(eva.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_,500,true)  
...
local ID_USER = MsgText[2]
redis:set(eva..'SET:ID:USER:NUM'..msg.chat_id_,ID_USER)  
redis:setex(eva.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_,500,true)  
sendMsg(msg.chat_id_,msg.id_,'*- حلو ، ارسل لي عدد النقاط الذي تريده*')
end
if not redis:get(eva..'lock_geams'..msg.chat_id_) and msg.GroupActive then
if MsgText[1] == 'اسئله' or MsgText[1] == 'ختيارات' or MsgText[1] == 'بدء الاسئله' then   
redis:set(eva.."GAME:S"..msg.chat_id_,true) 
t1 = [[
...
redis:set(eva.."GAME:CHER"..msg.chat_id_,'النيل') 
elseif SENDTEXT:find('14') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'14') 
elseif SENDTEXT:find('الفم') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'الفم') 
elseif SENDTEXT:find('11') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'11') 
elseif SENDTEXT:find('30') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'30') 
elseif SENDTEXT:find('بوتين') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'بوتين') 
elseif SENDTEXT:find('ستيف جوبر') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'ستيف جوبر') 
elseif SENDTEXT:find('باريس') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'باريس') 
elseif SENDTEXT:find('10') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'10') 
elseif SENDTEXT:find('النمل') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'النمل') 
elseif SENDTEXT:find('حرف الواو') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'حرف الواو') 
elseif SENDTEXT:find('الشعر') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'الشعر') 
elseif SENDTEXT:find('ابراهيم') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'ابراهيم') 
elseif SENDTEXT:find('سحاب') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'سحاب') 
elseif SENDTEXT:find('الاسم') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'الاسم') 
elseif SENDTEXT:find('ذهب') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'ذهب') 
elseif SENDTEXT:find('حرف الام') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'حرف الام') 
elseif SENDTEXT:find('العزائم') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'العزائم') 
elseif SENDTEXT:find('انسات') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'انسات') 
elseif SENDTEXT:find('المنجنيق') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'المنجنيق') 
elseif SENDTEXT:find('اسيا') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'اسيا') 
elseif SENDTEXT:find('الاسد') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'الاسد') 
elseif SENDTEXT:find('6') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'6') 
elseif SENDTEXT:find('مهر') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'مهر') 
elseif SENDTEXT:find('الدلفين') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'الدلفين') 
elseif SENDTEXT:find('اوروبا') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'اوروبا') 
elseif SENDTEXT:find('الزئبق') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'الزئبق') 
elseif SENDTEXT:find('لندن') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'لندن') 
elseif SENDTEXT:find('الانسان') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'الانسان') 
elseif SENDTEXT:find('طوكيو') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'طوكيو') 
elseif SENDTEXT:find('خديجه') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'خديجه') 
end
...
redis:set(eva.."GAME:CHER"..msg.chat_id_,'الطاوس')
elseif SENDTEXT:find('الصوره') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'الصوره')
elseif SENDTEXT:find('45') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'45')
elseif SENDTEXT:find('الإبره') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'الإبره')
elseif SENDTEXT:find('نوح') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'نوح')
elseif SENDTEXT:find('الماء') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'الماء')
elseif SENDTEXT:find('الحبر') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'الحبر')
elseif SENDTEXT:find('الزجاج') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'الزجاج')
elseif SENDTEXT:find('يديك') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'يديك')
elseif SENDTEXT:find('الضوء') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'الضوء')
elseif SENDTEXT:find('درب') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'درب')
elseif SENDTEXT:find('الشمع') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'الشمع')
elseif SENDTEXT:find('الثعبان') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'الثعبان')
elseif SENDTEXT:find('نجم') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'نجم')
elseif SENDTEXT:find('الطريق') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'الطريق')
elseif SENDTEXT:find('العطار') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'العطار')
elseif SENDTEXT:find('شبكه الصيد') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'شبكه الصيد')
elseif SENDTEXT:find('الصوت') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'الصوت')
elseif SENDTEXT:find('قابيل') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'قابيل')
elseif SENDTEXT:find('العقل') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'العقل')
elseif SENDTEXT:find('حرف') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'حرف')
elseif SENDTEXT:find('الكرسي') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'الكرسي')
elseif SENDTEXT:find('المبتدأ') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'المبتدأ')
elseif SENDTEXT:find('الحوت') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'الحوت')
elseif SENDTEXT:find('الساعه') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'الساعه')
elseif SENDTEXT:find('لا يوجد') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'لا يوجد')
elseif SENDTEXT:find('امك') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'امك')
end
sendMsg(msg.chat_id_,msg.id_,SENDTEXT)     
return false  
end
...
redis:set(eva..':Set_alii:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(eva..':Set_Amthlh:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(eva..':Set_Hzorh:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(eva..':Set_twet:'..msg.chat_id_,name)
...
Num = math.random(1,6)
redis:set(eva.."GAMES"..msg.chat_id_,Num) 
TEST = [[
*➀       ➁     ➂      ➃      ➄     ➅
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
...
redis:setex(eva.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
if MsgText[1] == 'خمن' or MsgText[1] == 'تخمين' then   
Num = math.random(1,20)
redis:set(eva.."GAMES:NUM"..msg.chat_id_,Num) 
TEST = '*\n-› اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n'..'- لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n'..'- سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟*'
sendMsg(msg.chat_id_,msg.id_,TEST)
redis:setex(eva.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
if (MsgText[1] == 'اسرع' or MsgText[1] == 'الاسرع') then
local NUM = math.random(10,1000)
redis:set(eva..':NUM_SET:'..msg.chat_id_,(NUM * 3))
...
redis:set(eva..':Set_Smile:'..msg.chat_id_,Emoji)
if tonumber(redis:get(eva..':Set_Smile:'..msg.chat_id_)) == tonumber(redis:get(eva..':NUM_SET:'..msg.chat_id_)) then
return '- اول من يكتب هذه العدد يفوز ؛  ››`'..(redis:get(eva..':Set_Smile:'..msg.chat_id_))..'`'
else
return '️- اول من يكتب هذه السمايل يفوز ››    `'..(redis:get(eva..':Set_Smile:'..msg.chat_id_))..'`'
end
end
...
name = katu[math.random(#katu)]
redis:set(eva..':Set_Arg:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(eva..':Set_Name_Meant:'..msg.chat_id_,name)
...
redis:set(eva.."GAME:CHER"..msg.chat_id_,'فهمت') 
elseif SENDTEXT:find('مو جبان') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'مو جبان') 
elseif SENDTEXT:find('عدل') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'عدل') 
elseif SENDTEXT:find('نشط') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'نشط') 
elseif SENDTEXT:find('مو زين') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'مو زين') 
elseif SENDTEXT:find('مو عطشان') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'مو عطشان') 
elseif SENDTEXT:find('حاره') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'حاره') 
elseif SENDTEXT:find('مو خايف') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'مو خايف') 
elseif SENDTEXT:find('خلف') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'خلف') 
elseif SENDTEXT:find('وفي') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'وفي') 
elseif SENDTEXT:find('قزم') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'قزم') 
elseif SENDTEXT:find('لين') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'لين') 
elseif SENDTEXT:find('خشن') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'خشن') 
elseif SENDTEXT:find('عاقل') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'عاقل') 
elseif SENDTEXT:find('ذكي') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'ذكي') 
elseif SENDTEXT:find('مو ظلمه') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'مو ظلمه') 
elseif SENDTEXT:find('مو مسموح') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'مو مسموح') 
elseif SENDTEXT:find('اسمعك') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'اسمعك') 
elseif SENDTEXT:find('روح') then
redis:set(eva.."GAME:CHER"..msg.chat_id_,'روح') 
end
sendMsg(msg.chat_id_,msg.id_,SENDTEXT)     
return false  
end
...
local points = redis:get(eva..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
redis:decrby(eva..':User_Points:'..msg.chat_id_..msg.sender_user_id_,MsgText[2])  
redis:incrby(eva..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_,Total_Point)  
return "-› تم خصم {* "..MsgText[2].." *} من نقاطك\n- تم زياده {* "..Total_Point.."* } من الرسائل \n- اصبحت رسائلك { *"..redis:get(eva..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_).."* } رساله"
end
end
if MsgText[1] == 'احكام' then
redis:del(eva..":Number_Add:"..msg.chat_id_..msg.sender_user_id_) 
redis:del(eva..':List_Rolet:'..msg.chat_id_)  
redis:setex(eva..":Start_Rolet:"..msg.chat_id_..msg.sender_user_id_,3600,true)  
return '*• * حسناً لنلعب , ارسل عدد اللاعبين  .'
end
if MsgText[1] == 'نعم' and redis:get(eva..":Witting_StartGame:"..msg.chat_id_..msg.sender_user_id_) then
local list = redis:smembers(eva..':List_Rolet:'..msg.chat_id_) 
if #list == 1 then 
...
redis:incrby(eva..':User_Points:'..msg.chat_id_..data.id_,5)
end,nil)
redis:del(eva..':List_Rolet:'..msg.chat_id_) 
redis:del(eva..":Witting_StartGame:"..msg.chat_id_..msg.sender_user_id_)
...
return [[ 
⌯︙•⊱ الالعاب لبوت []]..redis:get(eva..':NameBot:')..[[]  ، ! 🎖
...
[𝙳𝙴𝚅 : 𝙳𝙰𝚁𝙺](https://t.me/Da_rkk)
[𝙳𝙴𝚅 : 𝙴𝙻𝚃𝚄𝚁𝙺𝙴𝚈𝚈](https://t.me/HH22H)
...
◐‿◐ الالعاب لبوت []]..redis:get(eva..':NameBot:')..[[]  ، ! 🎖
...
if msg.text and not redis:get(eva..'lock_geams'..msg.chat_id_) then
if msg.text == redis:get(eva..':Set_alii:'..msg.chat_id_) then -- // المختلف
redis:incrby(eva..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(eva..':Set_alii:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*-›  احسنت اجابتك صحيحه \n*')
end

if msg.text == redis:get(eva..':Set_Amthlh:'..msg.chat_id_) then -- // امثله
redis:incrby(eva..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(eva..':Set_Amthlh:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*-›  احسنت اجابتك صحيحه \n*')
end

if msg.text == redis:get(eva..':Set_Hzorh:'..msg.chat_id_) then -- // حزوره
redis:incrby(eva..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(eva..':Set_Hzorh:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*-›  احسنت اجابتك صحيحه \n*')
end


if msg.text == redis:get(eva..':Set_Smile:'..msg.chat_id_) then --//  الاسرع
redis:incrby(eva..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(eva..':Set_Smile:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*-›  احسنت اجابتك صحيحه \n*')
end
 if msg.text == redis:get(eva..':Set_Smile:'..msg.chat_id_) then --//  الغاز
redis:incrby(eva..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(eva..':Set_Smile:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*-›  احسنت اجابتك صحيحه \n*')
end
...
if msg.text == redis:get(eva..':Set_Arg:'..msg.chat_id_) then -- // الترتيب
redis:incrby(eva..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(eva..':Set_Arg:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*-›  احسنت اجابتك صحيحه \n*')
end 
if msg.text == redis:get(eva..':Set_Name_Meant:'..msg.chat_id_) then --// المعاني
redis:incrby(eva..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(eva..':Set_Name_Meant:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*-›  احسنت اجابتك صحيحه \n*')
end 
if msg.text:match("^(%d+)$") and redis:get(eva..":Start_Rolet:"..msg.chat_id_..msg.sender_user_id_) then  --// استقبال اللعبه الدمبله
if msg.text == "1" then
Text = "*-›* لا استطيع بدء اللعبه بلاعب واحد فقط\n"
else
redis:set(eva..":Number_Add:"..msg.chat_id_..msg.sender_user_id_,msg.text)  
Text = '-› تم بدء تسجيل اللسته \n- يرجى ارسال المعرفات \n- الفائز يحصل على (5) مجوهره\n- عدد الاعبين المطلوبه { *'..msg.text..'* } لاعب'
end
redis:del(eva..":Start_Rolet:"..msg.chat_id_..msg.sender_user_id_)  
return sendMsg(msg.chat_id_,msg.id_,Text)    
end
if msg.text:match('^(@[%a%d_]+)$') and redis:get(eva..":Number_Add:"..msg.chat_id_..msg.sender_user_id_) then    --// استقبال الاسماء
if redis:sismember(eva..':List_Rolet:'..msg.chat_id_,msg.text) then
return sendMsg(msg.chat_id_,msg.id_,'*-›* المعرف {['..msg.text..']} موجود اساسا' )
end
redis:sadd(eva..':List_Rolet:'..msg.chat_id_,msg.text)
local CountAdd = redis:get(eva..":Number_Add:"..msg.chat_id_..msg.sender_user_id_)
local CountAll = redis:scard(eva..':List_Rolet:'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
redis:del(eva..":Number_Add:"..msg.chat_id_..msg.sender_user_id_) 
redis:setex(eva..":Witting_StartGame:"..msg.chat_id_..msg.sender_user_id_,1400,true)  
...
if redis:get(eva.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_) then 
...
redis:del(eva.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_)  
return false  end 
local GET_IDUSER = redis:get(eva..'SET:ID:USER'..msg.chat_id_)  
sendMsg(msg.chat_id_,msg.id_,"\n*-› تم اضافة { "..msg.text.." }* رساله له")
redis:incrby(eva..'msgs:'..GET_IDUSER..':'..msg.chat_id_,msg.text)  
end
redis:del(eva.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_)  
end
if redis:get(eva.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_) then 
if msg.text:match("^(%d+)$") then
if tonumber(msg.text:match("^(%d+)$")) > 99999999990 then
sendMsg(msg.chat_id_,msg.id_,"*-› لا تستطيع اضافة اكثر من 99999999990 نقطه*")   
redis:del(eva.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_)  
return false  end 
local GET_IDUSER = redis:get(eva..'SET:ID:USER:NUM'..msg.chat_id_)  
sendMsg(msg.chat_id_,msg.id_,"\n*-› تم اضافة { "..msg.text.." }* نقطه له")
redis:incrby(eva..':User_Points:'..msg.chat_id_..GET_IDUSER,msg.text)  
end
redis:del(eva.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_)  
end
if redis:get(eva.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if msg.text:match("^(%d+)$") then
local NUM = msg.text:match("^(%d+)$")
if tonumber(NUM) > 6 then
sendMsg(msg.chat_id_,msg.id_,"*-› عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخره*")   
return false  end 
local GETNUM = redis:get(eva.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
redis:del(eva.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
sendMsg(msg.chat_id_,msg.id_,'*-› مبروك فزت وطلعت المحيبس بل ايد رقم { '..NUM..' }\n- لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل *')   
redis:incrby(eva..':User_Points:'..msg.chat_id_..msg.sender_user_id_,3)  
...
if (msg.text == redis:get(eva.."GAME:CHER"..msg.chat_id_)) and redis:get(eva.."GAME:S"..msg.chat_id_) then  
sendMsg(msg.chat_id_,msg.id_,'【▣】شاطر انتا صح 【▣】')     
redis:incrby(eva..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(eva.."GAME:S"..msg.chat_id_)
redis:del(eva.."GAME:CHER"..msg.chat_id_)
...
if redis:get(eva.."GAME:S"..msg.chat_id_) then  
...
if redis:get(eva.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if msg.text:match("^(%d+)$") then
local NUM = msg.text:match("^(%d+)$")
if tonumber(NUM) > 20 then
sendMsg(msg.chat_id_,msg.id_,"*-› عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 } *")
return false  end 
local GETNUM = redis:get(eva.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
redis:del(eva..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
redis:del(eva.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
redis:incrby(eva..':User_Points:'..msg.chat_id_..data.id_,5)
sendMsg(msg.chat_id_,msg.id_,'*-› مبروك فزت ويانه وخمنت الرقم الصحيح\n- تم اضافة { 5 } من النقاط *')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
redis:incrby(eva..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(redis:get(eva..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
redis:del(eva..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
redis:del(eva.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
if redis:get(eva.."chencher"..msg.sender_user_id_) then 
if redis:get(eva.."chencher"..msg.sender_user_id_) ~= data.first_name_ then 
tahan = '['..(redis:get(eva.."chencher"..msg.sender_user_id_) or '')..']'
taham = '['..data.first_name_..']'
sendMsg(msg.chat_id_,msg.id_,taha[math.random(#taha)])
end  
end
redis:set(eva.."chencher"..msg.sender_user_id_, data.first_name_) 
end,nil) 
end
end
return {
